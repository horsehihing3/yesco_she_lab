...
public class OccupationalDiseaseController {
    ...
    @PostMapping("/plans") public ResponseEntity<ApiResponse<OdPlan>> createPlan(@RequestBody OdPlan e) { return ResponseEntity.ok(ApiResponse.success(svc.createPlan(e))); }
    ...
    @PostMapping("/workers") public ResponseEntity<ApiResponse<OdWorker>> createWorker(@RequestBody OdWorker e) { return ResponseEntity.ok(ApiResponse.success(svc.createWorker(e))); }
    ...
    @PostMapping("/orgs") public ResponseEntity<ApiResponse<OdOrg>> createOrg(@RequestBody OdOrg e) { return ResponseEntity.ok(ApiResponse.success(svc.createOrg(e))); }
    ...
    @PostMapping("/exposures") public ResponseEntity<ApiResponse<OdExposure>> createExp(@RequestBody OdExposure e) { return ResponseEntity.ok(ApiResponse.success(svc.createExposure(e))); }
    ...
    @PostMapping("/aftercare") public ResponseEntity<ApiResponse<OdAftercare>> createAft(@RequestBody OdAftercare e) { return ResponseEntity.ok(ApiResponse.success(svc.createAftercare(e))); }
    ...
    @PostMapping("/fitness") public ResponseEntity<ApiResponse<OdFitness>> createFit(@RequestBody OdFitness e) { return ResponseEntity.ok(ApiResponse.success(svc.createFitness(e))); }
