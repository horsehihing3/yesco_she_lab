          ...
          <Table size="small" sx={{ '& .MuiTableCell-root': { borderRight: '1px solid', borderColor: 'divider' }, '& .MuiTableCell-root:last-child': { borderRight: 'none' } }}>
            <TableHead>
              <TableRow>
                ...
                <TableCell align="center" sx={{ fontWeight: 'bold', borderRight: 1, borderColor: 'divider', wordBreak: 'keep-all' }}>{t('waste.compliance.checkDate')}</TableCell>
                <TableCell align="center" sx={{ fontWeight: 'bold', borderRight: 1, borderColor: 'divider', wordBreak: 'keep-all' }}>{t('waste.compliance.regulationName')}</TableCell>
                <TableCell align="center" sx={{ fontWeight: 'bold', borderRight: 1, borderColor: 'divider', wordBreak: 'keep-all' }}>{t('waste.compliance.checkItem')}</TableCell>
                <TableCell align="center" sx={{ fontWeight: 'bold', borderRight: 1, borderColor: 'divider', wordBreak: 'keep-all' }}>{t('waste.compliance.status')}</TableCell>
                <TableCell align="center" sx={{ fontWeight: 'bold', borderRight: 1, borderColor: 'divider', wordBreak: 'keep-all' }}>{t('waste.compliance.responsiblePerson')}</TableCell>
            ...
            <TableBody>
              {data && data.content.length > 0 ? data.content.map((item, idx) => (
                <TableRow key={item.id} hover sx={{ cursor: 'pointer' }} onClick={() => handleRowClick(item)}>
                  ...
                  <TableCell align="center" sx={{ borderRight: 1, borderColor: 'divider' }}>{formatDate(item.checkDate)}</TableCell>
                  <TableCell sx={{ borderRight: 1, borderColor: 'divider' }}>{item.regulationName || ''}</TableCell>
                  <TableCell sx={{ borderRight: 1, borderColor: 'divider' }}>{item.checkItem || ''}</TableCell>
                  ...
                  <TableCell align="center" sx={{ borderRight: 1, borderColor: 'divider' }}>{item.responsiblePerson || ''}</TableCell>
