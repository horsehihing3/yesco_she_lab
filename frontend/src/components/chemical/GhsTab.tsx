      ...
      <Grid container spacing={2} mb={3}>
        <Grid item xs={6} sm={3}>
          <Paper sx={metricCardSx}>
            <Typography variant="body2" color="text.secondary">{t('chem.ghs.totalSubstances', 'GHS 해당 물질')}</Typography>
            <Typography variant="h5" fontWeight="bold">{totalElements}</Typography>
          </Paper>
        </Grid>
        <Grid item xs={6} sm={3}>
          <Paper sx={metricCardSx}>
            <Typography variant="body2" color="text.secondary">{t('chem.ghs.classified', '분류 완료')}</Typography>
            <Typography variant="h5" fontWeight="bold" color="success.main">{classifiedCount}</Typography>
          </Paper>
        </Grid>
        <Grid item xs={6} sm={3}>
          <Paper sx={metricCardSx}>
            <Typography variant="body2" color="text.secondary">{t('chem.ghs.needReview', '검토 필요')}</Typography>
            <Typography variant="h5" fontWeight="bold" color="warning.main">{needUpdateCount}</Typography>
          </Paper>
        </Grid>
        <Grid item xs={6} sm={3}>
          <Paper sx={metricCardSx}>
            <Typography variant="body2" color="text.secondary">{t('chem.ghs.currentVersion', '현행 GHS 버전')}</Typography>
            <Typography variant="h5" fontWeight="bold">Rev.9</Typography>
          </Paper>
        </Grid>
      </Grid>
